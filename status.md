...
├── db/
│   ├── schema.sql                # SQLite схема (12 таблиц, вкл. proxy_events, pending_patches, plan_quality_scores, financial_records, agent_config_snapshots)
...
Schema.sql с 7 таблицами (сейчас 12). config.py. main_orchestrator.py с 7-шаговым циклом.
